...
def show_mnist_det(tbins=10, num_workers=1, batch_size=8, height=128, width=128, min_objects=1, max_objects=2, max_frames_per_video=10, max_frames_per_epoch=10000, delay=5, epochs=1):
